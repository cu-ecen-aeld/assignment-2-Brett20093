...
void test_validate_my_username()
{
     ...
     */
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(), malloc_username_from_conf_file(), "ERROR: my_username() and malloc_username_from_conf_file() are not returning the same string.");
}
